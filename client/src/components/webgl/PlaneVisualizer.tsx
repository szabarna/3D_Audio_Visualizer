...
export default function PlaneVisualizer(props: any) {
  ...
  useEffect(() => {
    ...
    visualizerMesh.current.geometry.setAttribute(
      "position",
  ...
  return (
    <>
      <points ref={visualizerMesh} rotation={[Math.PI * 1.6, 0, 0]}>
        <bufferGeometry attach={"geometry"} />
        <shaderMaterial
          ref={visualizerMat}
          attach={"material"}
          args={[VisualizerShaderMaterial2]}
          wireframe={false}
        />
      </points>
    </>
